...
import { checkVerifyOrder, getDetailOrder } from "@/lib/api";
import { FORMAT_STATUS_ORDER, PaymentMethodEnum, StatusOrderEnum } from "@/types/order";
    ...
    <React.Fragment>
      ...
      <div className="bg-neutral-100 py-20">
        <Wrapper className="p-10 bg-white flex flex-col items-center gap-4">
          {isSuccess ? (
            <CheckCircle2Icon className="text-primary w-40 h-40" strokeWidth={1} />
          ) : (
